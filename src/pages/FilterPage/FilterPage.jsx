...
import FilterList from "../../components/reUsableComponents/FilterComponents/FilterList";
...
const FilterPage = () => {
  ...
  const handleApplyFilters = () => {
    navigate("/home", { state: { filtersApplied: selectedFilters } });   //route need to be updated later
  };
