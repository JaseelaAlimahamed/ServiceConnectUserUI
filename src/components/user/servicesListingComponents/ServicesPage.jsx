...
import FilterButtons from "./LocationFilterButtons"; // Import the FilterButtons component
  ...
  return (
    <div className="min-h-screen bg-light-gray">
      ...
      <div className="bg-light-gray p-4">
        ...
        <button className="mt-2 w-full py-2 bg-dark-gray text-white rounded-3xl">
