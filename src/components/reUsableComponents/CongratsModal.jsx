...
Modal.setAppElement('#root'); // Ensure the accessibility element is set
...
const CongratsModal = ({
  ...
  return (
    <Modal
      ...
      overlayClassName="modal-overlay fixed inset-0 z-50 flex items-center justify-center backdrop-blur-lg bg-black-500/60"
    >
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 lg:p-12 text-center flex flex-col items-center justify-center space-y-4 max-w-sm sm:max-w-md mx-auto w-full">
        {img && <img src={img} className="w-50 h-40 sm:w-40 sm:h-40 md:w-60 md:h-50 lg:w-80 lg:h-60" alt="Congrats" />}
