...
const Home = () => {
    ...
    return (
        ...
        {isLoading ? (
            ...
            <div className=" py-4 mt-16 lg:ml-24 lgm:ml-16 md:mt-10 md:px-8 lg:px-12 lgx:ml-36 w-full max-w-[95vw] sm:max-w-[90vw] md:max-w-[76vw] lgm:max-w-[80vw] lgx:max-w-[80vw] lg:max-w-[78vw] xl:max-w-screen-xl">
