  ...
  return (
    ...
    >
      <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 lg:p-12 text-center flex flex-col items-center justify-center space-y-4 max-w-sm sm:max-w-md mx-auto w-full">
        ...
        <p className="mt-2 text-center text-gray-600 sm:text-lg md:text-xl">{message}</p>
        <Link className="underline text-#167F71 font-default font-semibold text-[16px]">{link}</Link>
        <ButtonComponent
